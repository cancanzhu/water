...
class Track(genpy.Message):
  _md5sum = "527d334e3f10954bd65c67a79b62ccc6"
...
"""
  __slots__ = ['id','age','pos','vel','pos_cov','vel_cov','associated']
  _slot_types = ['int32','float64','geometry_msgs/Point','geometry_msgs/Vector3','float64[9]','float64[9]','hdl_people_tracking/Cluster[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,age,pos,vel,pos_cov,vel_cov,associated
