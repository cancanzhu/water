...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Track>)))
  ...
  "527d334e3f10954bd65c67a79b62ccc6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Track)))
  "Returns md5sum for a message object of type 'Track"
  "527d334e3f10954bd65c67a79b62ccc6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Track>)))
  ...
  (cl:format cl:nil "int32 id~%float64 age~%geometry_msgs/Point pos~%geometry_msgs/Vector3 vel~%~%float64[9] pos_cov~%float64[9] vel_cov~%~%hdl_people_tracking/Cluster[] associated~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: hdl_people_tracking/Cluster~%bool is_human~%~%geometry_msgs/Point min_pt~%geometry_msgs/Point max_pt~%geometry_msgs/Vector3 size~%geometry_msgs/Point centroid~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Track)))
  "Returns full string definition for message of type 'Track"
  (cl:format cl:nil "int32 id~%float64 age~%geometry_msgs/Point pos~%geometry_msgs/Vector3 vel~%~%float64[9] pos_cov~%float64[9] vel_cov~%~%hdl_people_tracking/Cluster[] associated~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: hdl_people_tracking/Cluster~%bool is_human~%~%geometry_msgs/Point min_pt~%geometry_msgs/Point max_pt~%geometry_msgs/Vector3 size~%geometry_msgs/Point centroid~%~%~%"))
